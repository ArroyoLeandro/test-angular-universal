...
@Component({
  selector: 'app-checkout03',
  templateUrl: './checkout03.component.html',
  styleUrls: ['./checkout03.component.scss']
})
export class Checkout03Component implements OnInit {

  public step: any = 1;
  public minValDelivery=899;
  public modalThanks: boolean = false;
  /********************** LOGIC PROMO */
  public mountGift=719000;
  ...
  constructor(
    ...
    if(this.promotionInfo){
      this.mountGift=this.promotionInfo.amount;
      if(this.mountGift==null){
        this.mountGift=719000;
      }
    }
  ...
  cantidadJoieros(){
    return Math.floor(this.cartTotal/this.mountGift);
  }
